      ...
      <div className="container mx-auto flex flex-wrap items-center justify-between">
        ...
        <div className="hidden md:flex md:items-center md:w-auto w-full" id="navbarNavLarge">
          <div className="md:flex-grow md:flex md:justify-end">
            <div className="flex flex-col md:flex-row md:space-x-4 md:items-center ">
              <Link to="/login" className=" text-lg focus:outline-none mx-auto p-2">Iniciar sesión</Link>
              <Link to="/register" className=" text-lg focus:outline-none mx-auto p-2">Regístrate</Link>
            </div>
          </div>
        </div>
        ...
        <div className={`md:hidden ${isOpen ? 'block' : 'hidden'} w-full `} id="navbarNavSmall">
          <div className="flex flex-col md:flex-row md:space-x-4 md:items-center justify-center">
            <Link to="/login" className=" text-lg focus:outline-none mx-auto p-2  bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-8 uppercase transition duration-300">Iniciar sesión</Link>
          </div>
          <div className="flex flex-col md:flex-row md:space-x-4 md:items-center justify-center mt-4">
          <Link to="/register" className=" text-lg focus:outline-none mx-auto p-2  bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-8  uppercase transition duration-300">Registrate</Link>
          </div>
        </div>
